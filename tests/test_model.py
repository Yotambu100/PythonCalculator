...
TEST_DATA = [
    ...
    ("005*2^2&2\t -7&88+224@2\n \t6-(43-44\n +66&2----45*(321&2))", 47),
    ("7&8*22^3!-7^3+((22\n %2*7\t\t \n )+3$5^3&~7)", 793658985.0000128),
    ("14  $5%2&\t 4+4+4-7.7+(5*3$\n\n \t\t 2)!$36821", 1307674368000.3),
    ("24%12^2-7*9&(2+3-4+\t\t 6$22--8--~((9+8)!))", 2489811996671783.0),
    ("55%6$ 2  *8^2+5--65^2*(  (3$\n\n5^5)+6^\n 2&12^2)-2", 18678792.0),
    ("123/86+996-22\n*77$(6^ 2%4-(8-7+5^3*2$3^7))", -696.5697674418604),
    ("~((88/23 * 2.2) ^ 3\n   &(5!+---6^3)) ", -1.5239066784713154e-89),
    ("4--~~ ~3+22!+4!!--~ ~(33\n +6^2-~(5+7)+2)", 6.21572402461017e+23),
    ("5\n\t\n 23 5^2-7*  22%(3 !+4\t\t\t\t5-7*(44$2@12 ))", 27406086.0),
    ("4$55^27* 22&44*(23$2^2&43* 6&(65^2+2--6))", 6.82059432867212e+51),
    ("--- -(  8*--8)$ 5+2%45 6+9   \n   *9*~(6+6)+2^(-(1+1))", -905.75),
    ("87^3\t\n\t   %2&66@4   *~5%((22%4$2^2)+7 *6!)^2 *6", 152349126.0),
    ("87^3%2&66@45%((22%4$2^2)+7*6!)^~2\n  *6", 1.3836802264343499e-11),
    ("(123 @ ((145*2/4%6-6/7) @ ~(3\t ^5 - 9000)))", 2268.660714285714),
    (" ~( 123@((145*  2/4 %6-6  /7)@( 3^5 -9000)))", 2109.839285714286),
    ("4--~~ ~3+22!+4--~ \t ~(33+6^2-~(5+7)+2)", 1.1240007277776077e+21),
    ("((2+4-6^ ~2-4+2)/(2+3^2 /5&2@56)+7 6-~(4!))", 101.71932006633499),
    ("( (1+(3+(5*7)-9)@4.5\t7) * (2.5) ) / ~(-5.1)", 8.718137254901961),
    ("18- 6 ^2+5%4  $  3 +2+4 +5+6 ------- 9+7&  5/3.2 % 4.2", -7.4375),
    ("5 \n  2/(93 --9   8---  1 5*2 +3!)%8.    12", 11.304347826086918),
    ("--~4+6! +   7*2-4   \t        2/21+(2     &3*2   %  3^2)", 736.0),
    ("1 4 $5%2&4+4+4-7. 7+-( 5*3$2) \t\t\t\t\t   ! ", -1307674367999.7),
]
